...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=LAPTOP_ANDRES\\SQLEXPRESS; database=dbPymes; integrated security=true; Encrypt=False;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Manufacturing>(entity =>
        {
            ...
            entity.HasOne(d => d.IdBatchNavigation).WithMany(p => p.Manufacturings)
                .HasForeignKey(d => d.IdBatch)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Manufacturing_ManufacturingBatch");
        });
        ...
        modelBuilder.Entity<ManufacturingBatch>(entity =>
        {
            ...
            entity.HasOne(d => d.IdManufacturingNavigation).WithMany(p => p.ManufacturingBatches)
                .HasForeignKey(d => d.IdManufacturing)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ManufacturingBatch_Manufacturing");

            entity.HasOne(d => d.IdProductNavigation).WithMany(p => p.ManufacturingBatches)
                .HasForeignKey(d => d.IdProduct)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ManufacturingBatch_Product");
        });
        ...
        modelBuilder.Entity<Supply>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.IdRawMaterial).HasColumnName("idRawMaterial");
            entity.Property(e => e.IdSupplir).HasColumnName("idSupplir");
            entity.Property(e => e.LastUpdate)
                .HasColumnType("datetime")
                .HasColumnName("lastUpdate");
            entity.Property(e => e.Quantity).HasColumnName("quantity");
            ...
            entity.HasOne(d => d.IdSupplirNavigation).WithMany(p => p.Supplies)
                .HasForeignKey(d => d.IdSupplir)
                .OnDelete(DeleteBehavior.ClientSetNull)
